...
public class PointerFollow : MonoBehaviour
{
    ...
    [SerializeField] private Camera camera; //Definimos una variable de tipo Camera, porque será apartir de esta donde obtengamos las coordenadas y demás necesario para seguir a el ratón
    ...
    void Update()
    {
        Vector3 mousePos = camera.ScreenToWorldPoint(Input.mousePosition); //De esta forma pasamos la posición de el ratón a coordenadas de el mundo
